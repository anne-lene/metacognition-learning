...
# Fit models to data from Experiment 2 - Variable Feedback
import numpy as np
import pandas as pd
...
def main(df):
    ...
    # Relative save path
    relative_path = "../../results/variable_feedback/model_comparison/models_fit_to_data"

    # Construct the full path to the file
    file_path = os.path.normpath(os.path.join(script_dir, relative_path))
    file_name = r"model_fits_EXP2_data_test1"
